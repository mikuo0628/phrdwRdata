####################################################################
# fn_stibbi_mdx_queries - mdx queries for pullling stibbi data - QA
#
...
# Created: 2019-10-09
#
# Modification: Please See Git Comments
#
####################################################################
...
stibbi_case_query <- function(query_start_date, query_end_date, parameter_list)
{
...
stibbi_investigation_query <- function(query_start_date, query_end_date, parameter_list)
{
...
stibbi_client_query <- function(query_start_date, query_end_date, parameter_list)
{
...
stibbi_body_site_query <- function(query_start_date, query_end_date, parameter_list)
{
  mdx_query = "SELECT
	[Measures].[PHS Disease Event Count]
  ON COLUMNS,
...
stibbi_client_risk_factor_query <- function(query_start_date, query_end_date, parameter_list)
{
  mdx_query = "SELECT
	[Measures].[PHS Disease Event Count]
  ON COLUMNS,
...
stibbi_investigation_risk_factor_query <- function(query_start_date, query_end_date, parameter_list)
{
  mdx_query = "SELECT
	[Measures].[PHS Disease Event Count]
  ON COLUMNS,
...
stibbi_udf_long_query <- function(query_start_date, query_end_date, parameter_list)
{
  mdx_query = "SELECT
	[Measures].[PHS Disease Event Count]
ON COLUMNS,
...
stibbi_lis_test_volume_query <- function(query_start_date, query_end_date, parameter_list)
{
  test_volume_mdx = "
  SELECT
NON EMPTY {
...
#
stibbi_lis_test_provider_query <- function(query_start_date, query_end_date, parameter_list)
{
  mdx_query = "
  SELECT
NON EMPTY {
...
#
stibbi_lis_episode_query <- function(query_start_date, query_end_date, parameter_list)
{
  mdx_query = "SELECT
NON EMPTY {
...
stibbi_lis_poc_query <- function(query_start_date, query_end_date, parameter_list)
{
  #
